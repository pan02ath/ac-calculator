...
KENAK_ΖΩΝΗ = {"Ζώνη Α – Αθήνα, Ηράκλειο, Ρόδος, νησιά Αιγαίου": 240, "Ζώνη Β – Θεσσαλονίκη, Πάτρα, Βόλος, Λάρισα": 210, "Ζώνη Γ – Ιωάννινα, Κοζάνη, Τρίκαλα": 190, "Ζώνη Δ - περιοχές με υψόμετρο άνω των 500 μέτρων": 170}
...
st.title("Υπολογιστής ενεργειακών απαιτήσεων για κλιματιστικά")
...
with c6:
    ...
    οροφή = st.selectbox("Τύπος οροφής", list(ΟΡΟΦΗ.keys())) if οροφή_υπάρχει else "μονωμένη"
...
if st.button("Υπολογισμός"):
    try:
        ...
        if περιστασιακή or αθόρυβη or βόρειος:
            st.warning("⚠️ Τα αποτελέσματα έχουν προσαυξηθεί βάσει των επιλογών χρήσης περιστασικακή και αθόρυβη. ")
