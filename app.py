...
if mode != st.session_state.mode:
    ...
    st.session_state.tin = 25 if mode == "cooling" else 21
...
μπαλκονόπορτες = st.number_input("Διπλές μπαλκονόπορτες", 0, 10, 1)
μονές = st.number_input("Μονές μπαλκονόπορτες", 0, 5, 0)
συρόμενες = st.number_input("Συρόμενες", 0, 5, 0)

kenak_zone = st.selectbox("Κλιματική ζώνη", list(KENAK_ΖΩΝΗ.keys()))
