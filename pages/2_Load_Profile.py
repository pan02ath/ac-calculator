...
if has_heating and has_cooling:
    ...
    st.info("Φορτωμένα μόνο στοιχεία θέρμανσης. Εκτελέστε τον υπολογιστή και σε λειτουργία ψύξης για το πλήρες διάγραμμα.")
else:
    st.info("Φορτωμένα μόνο στοιχεία ψύξης. Εκτελέστε τον υπολογιστή και σε λειτουργία θέρμανσης για το πλήρες διάγραμμα.")
...
st.info(
    f"Οι παραπάνω τιμές αφορούν τις μέγιστες τιμές ισχύος ενός κλιματιστικού στις δεδομένες θερμοκρασίες, "
    f"ώστε να καλύπτονται οι ανάγκες θέρμανσης και ψύξης ενός χώρου σε όλο το ενδιάμεσο εύρος θερμοκρασιών."
)
