...
if has_heating and has_cooling:
    st.success("Έγινε εισαγωγή των στοιχείων που εισάγατε για θέρμανση και ψύξη.")
elif has_heating:
...
st.header("Κλιματικά δεδομένα περιοχής για επιλογή συνθηκών σχεδιασμού")
st.caption(
...
st.info(
    ...
    f"συνιστώμενο εύρος ισχύος: **{recommended} BTU**. "
    f"Η παραπάνω τιμή αφορά την ονομαστική ισχύ ενός κλιματιστικού "
    f"που καλύπτει τις ανάγκες ενός χώρου τόσο σε ψύξη όσο και σε θέρμανση."
)
