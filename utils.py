...
# =========================================================
# DATA TABLES (EN 12831 & KENAK compliant)
# =========================================================
...
# Severity factors for leakage amplification
...
ΔΑΠΕΔΟ = ["άλλο_διαμέρισμα", "πιλοτή", "μη_θερμαινόμενος_χώρος", "έδαφος"]
ΟΡΟΦΗ = ["ταράτσα_εκτεθειμένη", "κεραμοσκεπή", "μη_θερμαινόμενος_χώρος", "θερμαινόμενος_χώρος"]
...
ΝΟΜΟΙ_ΖΩΝΗ = {"Αττική": "Β", "Θεσσαλονίκη": "Γ", "Αργολίδα": "Α", "Γρεβενά": "Δ", "Κρήτη": "Α"} # Truncated for brevity
# ... (rest of ΝΟΜΟΙ_ΖΩΝΗ from your original file)
...
ADJACENCY_B = {
    "άλλο_διαμέρισμα": 0.0, # Zero loss if heated
    "θερμαινόμενος_χώρος": 0.0,
    "μη_θερμαινόμενος_χώρος": 0.50,
    "πιλοτή": 1.0, # Full exposure
...
def υπολογισμός(d, mode):
    ...
    # Roof (Conditional)
    if d["οροφή"] == "θερμαινόμενος_χώρος":
        U_roof, b_roof = 0, 0
    else:
    ...
    # 3. TOTALS
    if mode == "θέρμανση":
        total = (transmission + infiltration) * 1.10 # Safety factor
    ...
    # 4. DERATING & PENALTIES
    temp = d["εξωτερική"]
    f_derating = 1.0 # Default
    if mode == "θέρμανση":
